...
<body id="page-top">
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarResponsive">
                <ul class="navbar-nav text-uppercase ms-auto py-4 py-lg-0">
                    <li class="nav-item"><a class="nav-link" href="#services">Sobre o evento</a></li>
                    <li class="nav-item"><a class="nav-link" href="#portfolio">Módulos</a></li>
                    <li class="nav-item"><a class="nav-link" href="#about">Edições</a></li>
                    <li class="nav-item"><a class="nav-link" href="#team">Vencedores</a></li>
                    <li class="nav-item"><a class="nav-link" href="#contact">Inscreva-se</a></li>
                </ul>
            </div>
        </div>
    </nav>
    ...
    <header class="masthead">
        <div class="container">
            <div class="masthead-subheading">SENAI DEV EXPERIENCE</div>
            <div class="masthead-heading text-uppercase">Uma experiência única, um mundo de oportunidades!</div>
            <a class="btn btn-primary btn-xl text-uppercase" href="#services">Conheça mais</a>
        </div>
    </header>
    <!-- Services-->
    <section class="page-section" id="services">
        <div class="container">
            <div class="text-center">
                ...
                <h3 class="section-subheading text-muted">Representa mais do que uma simples competição; trata-se uma
                    imersão
                    profunda no universo da tecnologia</h3>
            </div>
            <div class="row text-center">
                <div class="col-md-4">
                    ...
                    <h4 class="my-3">Maratona</h4>
                    <p class="text-muted">É uma maratona de tecnologia que reúne estudantes de nível técnico da
                ...
                <div class="col-md-4">
                    ...
                    <p class="text-muted">Potencializar o aprendizado e a interação
                        colaborativa entre estudantes.</p>
                </div>
                <div class="col-md-4">
                    <span class="fa-stack fa-4x">
                        <i class="fas fa-circle fa-stack-2x text-primary"></i>
        ...
        <div class="container">
            <div class="row align-items-center">
                <div class="col-md-3 col-sm-6 my-3">
                    <img class="img-fluid img-brand d-block mx-auto" src="img/branco.png"
